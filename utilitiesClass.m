classdef utilitiesClass < handle
    ...
    methods
        ...
        function plotSolution(obj)
            ...
            hold on
            plot(obj.mesh.x, obj.euler.state.u./obj.euler.state.a, '*', 'LineWidth', 1, 'Color', 'black', 'MarkerSize', 7);
            ...
            hold on
            plot(obj.mesh.x, obj.euler.state.rho*obj.thermo.RhoInf, '*', 'LineWidth', 1, 'Color', 'black', 'MarkerSize', 7);
